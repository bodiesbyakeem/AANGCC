...
function ContactSection() {
  ...
  const handleSubmit = (e: React.MouseEvent) => {
    e.preventDefault();
    // Replace with your form submission logic (e.g. Formspree, EmailJS, API route)
    setSubmitted(true);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
                ...
                >
                  {item.href ? (
                    ...
                    >
                      ...
                      <div>
                        <div className="text-white/30 text-[11px] tracking-wide uppercase font-medium mb-[2px]">
                          {item.label}
                        </div>
                        <div className="text-white/70 text-[13px] group-hover:text-white transition-colors duration-200">
                          {item.value}
                        </div>
                      </div>
                    </a>
            ...
            <div className="p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02]">
              <div className="text-white/30 text-[11px] tracking-wide uppercase font-medium mb-4">
                Quick Links
              </div>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        ...
                        <option value="membership" className="bg-[#141414]">Membership Inquiry</option>
                        <option value="sponsorship" className="bg-[#141414]">Corporate Sponsorship</option>
                        <option value="donation" className="bg-[#141414]">Donation</option>
                        <option value="rides" className="bg-[#141414]">Rides & Events</option>
                        <option value="media" className="bg-[#141414]">Media & Press</option>
