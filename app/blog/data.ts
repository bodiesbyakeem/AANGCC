...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    category: "Beginner",
    tags: ["Austin Cycling", "Group Rides", "Bike Safety"],
    color: "teal",
  ...
  },
  {
    ...
    category: "Beginner",
    tags: ["Group Rides", "Austin Cycling", "Bike Safety"],
    color: "teal",
  ...
  },
  {
    ...
    category: "Beginner",
    tags: ["Austin Cycling", "Bike Safety"],
    color: "gold",
  ...
  },
  {
    ...
    category: "Beginner",
    tags: ["Austin Cycling", "Group Rides"],
    color: "teal",
  ...
  },
  {
    ...
    category: "Beginner",
    tags: ["Bike Safety", "Austin Cycling"],
    color: "gold",
  ...
  },
  {
    ...
    category: "Beginner",
    tags: ["Group Rides", "Austin Cycling"],
    color: "gold",
  ...
  },
  {
    ...
    category: "Advanced",
    tags: ["Group Rides", "Bike Safety", "Training"],
    color: "teal",
  ...
  },
  {
    ...
    category: "Advanced",
    tags: ["Training", "Charity Cycling", "MS Awareness"],
    color: "gold",
  ...
  },
  {
    ...
    category: "Community",
    tags: ["Charity Cycling", "Fundraising", "MS Awareness"],
    color: "gold",
  ...
  },
  {
    ...
    category: "Community",
    tags: ["MS Awareness", "Fundraising", "Charity Cycling", "Austin Cycling"],
    color: "teal",
  ...
  {
    slug: "aangcc-2026-ms-150-biggest-year-yet",
    category: "Community",
    tags: ["MS Awareness", "Fundraising", "Charity Cycling", "Austin Cycling"],
    color: "teal",
    image: "/images/2026 MS 150 104.jpg",
    title: "AANGCC at the 2026 MS 150: Our Biggest Year Yet",
    excerpt: "156 miles. Two days. Nine riders. And a fundraising total that reminded us exactly why we do this. The 2026 Texas Bike MS 150 was the most meaningful ride in our club's history.",
    content: "156 miles. Two days. Nine riders. And a fundraising total that reminded us exactly why we do this. The 2026 Texas Bike MS 150 was the most meaningful ride in our club's history.\n\nWe rolled out of the San Jacinto Parking Garage in downtown Austin before sunrise on April 25th. The air was cool, the energy was high, and every rider on the team understood what we were carrying into those miles — the names, the stories, and the faces of people living with Multiple Sclerosis who depend on the research and programs this ride supports.\n\nDay one took us from Austin to La Grange. The roads through the Texas Hill Country were challenging in the best way — long stretches of open highway, rolling terrain, and enough headwind to remind us that this was not a leisure ride. But the team stayed together. We communicated, we encouraged each other, and we kept moving.\n\nDay two was the closer. From La Grange, we pushed through to the finish line in College Station, where the crowd and the emotion of crossing together made everything worth it.\n\nAs a team, AANGCC raised $35,772 in 2026 — our highest single-year fundraising total in club history. With 363 individual donations and an average gift of $98.55, the generosity of everyone who donated reflected something powerful: people believe in what we are doing.\n\nWe are already preparing for the 2027 MS 150. And we will be back, stronger and more committed than ever.",
    readTime: "5 min read",
    author: "AANGCC",
    date: "2026-05-01",
  },
  {
    slug: "what-35772-looks-like-aangcc-2026-ms-150-fundraising-story",
    category: "Community",
    tags: ["MS Awareness", "Fundraising", "Charity Cycling", "Austin Cycling"],
    color: "gold",
    image: "/images/2026 MS 150 81.jpg",
    title: "What $35,772 Looks Like: AANGCC's 2026 MS 150 Fundraising Story",
    excerpt: "Numbers tell one story. The people behind those numbers tell another. Here is what $35,772 raised for the National MS Society actually means.",
    content: "Numbers tell one story. The people behind those numbers tell another. Here is what $35,772 raised for the National MS Society actually means.\n\nIn 2026, nine AANGCC riders collectively raised $35,772 for the National Multiple Sclerosis Society through the Texas Bike MS 150. That total came from 363 individual donations, averaging $98.55 each. It represents donors from across Austin, across Texas, and beyond — family members, coworkers, neighbors, and strangers who believed enough in the cause to open their wallets.\n\nNearly 1 million Americans are living with MS. It is an unpredictable disease — one that can affect vision, balance, mobility, and independence. There is no cure. But there is research. And research is funded by rides like ours.\n\nEvery dollar raised by AANGCC goes to the National MS Society, which directs funding toward breakthrough research, local programs, and support for people and families living with MS right now. It funds neurologists studying disease progression. It funds navigators who help patients understand their options. It funds programs that help people with MS stay active, employed, and connected.\n\n$35,772 is a number we are proud of. But more than the total, we are proud of the 363 people who believed in our team. Each donation was a vote of confidence in what cycling can do when it is guided by purpose.\n\nWe ride again in 2027. And we will be asking you to believe in us again.",
    readTime: "4 min read",
    author: "AANGCC",
    date: "2026-05-15",
  },
  {
    slug: "how-to-train-for-2026-ride-to-end-alz",
    category: "Advanced",
    tags: ["Training", "Charity Cycling", "Austin Cycling"],
    color: "teal",
    image: "/images/2025 ALZ RIDE 3.jpg",
    title: "How to Train for the 2026 Ride to End ALZ",
    excerpt: "The Ride to End ALZ on October 17, 2026 in Dripping Springs is 40 miles through the Texas Hill Country. Here is how to prepare smart and arrive ready.",
    content: "The Ride to End ALZ on October 17, 2026 in Dripping Springs is 40 miles through the Texas Hill Country — beautiful, rolling terrain with enough elevation gain to make a strong fitness foundation essential. Whether this is your first charity ride or you are returning for another year, here is how to prepare smart and arrive ready.\n\nStart your dedicated build at least eight to ten weeks out. For newer riders, focus on consistency — getting out three to four times per week and extending your longest ride progressively. By two weeks before the event, you should have completed at least one ride of 30 miles or more at a conversational pace.\n\nFor experienced riders, use the build to include some tempo work and climbing simulation. Austin and the surrounding Hill Country offer excellent training terrain. Routes through Bee Cave, Lakeway, Wimberley, and Spicewood all provide the kind of rolling climbs that will appear on race day.\n\nFueling and hydration matter more than most riders expect on a 40-mile charity ride. The October heat in Central Texas can be significant, especially for morning starts. Practice drinking on the bike, bring two water bottles, and do not skip the rest stops.\n\nMentally, arrive focused on the mission. Ride to End ALZ is not about race results. It is about honoring the millions of families affected by Alzheimer's disease and contributing to the research that may one day end it. Let that purpose carry you through the hard miles.\n\nAre you riding with AANGCC on October 17th? Our team will be there. We would love to share the road with you.",
    readTime: "5 min read",
    author: "AANGCC",
    date: "2026-06-01",
  },
