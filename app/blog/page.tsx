              ...
              <div className={`relative rounded-2xl border overflow-hidden group cursor-pointer ${featured.color === "gold" ? "border-[#FFD84D]/20" : "border-[#2A9D9E]/20"}`}>
                ...
                <div className="relative h-[320px] lg:h-[400px] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-12">
                    ...
                    <h2 className="font-heading text-white text-[26px] lg:text-[38px] font-semibold leading-tight mb-3 max-w-[700px] group-hover:text-[#2A9D9E] transition-colors duration-300">
                      {featured.title}
                    </h2>
          ...
          {rest.map((post, i) => (
            ...
            >
              <Link href={`/blog/${post.slug}`}>
                <div className={`relative rounded-2xl border overflow-hidden flex flex-col h-full group cursor-pointer ${post.color === "gold" ? "border-[#FFD84D]/15" : "border-white/[0.07]"} bg-[#141414]`}>
                  {/* Image */}
                  <div className="relative h-[200px] overflow-hidden">
                    <img src={post.image} alt={post.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#141414] to-transparent" />
                    <div className="absolute top-3 left-3">
                      <span className={`text-[10px] font-semibold tracking-[0.2em] uppercase px-2 py-1 rounded-full ${post.color === "gold" ? "bg-[#FFD84D]/20 text-[#FFD84D]" : "bg-[#2A9D9E]/20 text-[#2A9D9E]"}`}>
                        {post.category}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 flex flex-col gap-3 flex-1">
                    <h3 className="font-heading text-white text-[19px] font-semibold leading-tight group-hover:text-[#2A9D9E] transition-colors duration-300">
                      {post.title}
                    </h3>
