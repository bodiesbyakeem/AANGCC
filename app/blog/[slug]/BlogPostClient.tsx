    ...
    <div className="min-h-screen bg-black pt-[72px]">
      ...
      <section className="relative h-[50vh] lg:h-[60vh] overflow-hidden">
        ...
        <div className="absolute top-8 left-6 lg:left-10 z-10">
          <Link
            href="/blog"
            className="flex items-center gap-2 text-white/60 hover:text-white transition-colors duration-200 text-[13px] font-medium"
          >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-16 max-w-[1400px] mx-auto">
          ...
          >
            ...
            <h1
              className="font-heading text-white leading-tight max-w-[800px]"
        ...
        <div className="max-w-[760px] mx-auto px-6 lg:px-10">
          ...
          >
            {post.content.split("\n\n").map((paragraph, i) => (
              <p
                key={i}
                className="text-white/65 text-[17px] leading-[1.85] font-light"
              >
                {paragraph}
              </p>
            ))}
        ...
        <section className="relative bg-[#0a0a0a] py-20 border-t border-white/[0.06]">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            ...
            >
              ...
              <h2 className="font-heading text-white text-[28px] lg:text-[36px] font-semibold">
                Related Articles
              </h2>
            </motion.div>
                  ...
                  <Link href={`/blog/${rel.slug}`}>
                    <div className={`relative rounded-2xl border overflow-hidden group cursor-pointer bg-[#141414] ${rel.color === "gold" ? "border-[#FFD84D]/15" : "border-white/[0.07]"}`}>
                      ...
                      <div className="p-5 flex flex-col gap-2">
                        <h3 className="font-heading text-white text-[17px] font-semibold leading-snug group-hover:text-[#2A9D9E] transition-colors duration-300">
                          {rel.title}
                        </h3>
