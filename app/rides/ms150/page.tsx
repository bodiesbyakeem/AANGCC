  ...
  return (
    <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-black pt-[72px]">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 text-center">
        ...
        <motion.p variants={fadeUp} initial="hidden" animate="visible" custom={0.3} className="font-heading text-white/40 text-[20px] lg:text-[26px] mb-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
          {stats.map((s, i) => (
            ...
            >
              ...
              <div className="text-white/30 text-[11px] tracking-wide uppercase">{s.label}</div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            {[
              ...
              <div
                key={day.day}
                className={`rounded-2xl border overflow-hidden ${day.color === "gold" ? "border-[#FFD84D]/20 bg-[#FFD84D]/[0.02]" : "border-white/[0.07] bg-[#141414]"}`}
              >
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <span className={`text-[11px] font-semibold tracking-[0.2em] uppercase ${day.color === "gold" ? "text-[#FFD84D]" : "text-[#2A9D9E]"}`}>{day.day}</span>
                      <h3 className="font-heading text-white text-[20px] font-semibold mt-1">{day.route}</h3>
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-[#2A9D9E] text-[11px] font-semibold tracking-[0.2em] uppercase">Team Training</span>
            </div>
            <h3 className="font-heading text-white text-[26px] font-semibold">We train together.</h3>
            <p className="text-white/40 text-[14px] leading-relaxed">
              AANGCC runs a structured MS 150 training program in the
              months leading up to the event. Weekly long rides, pace
              groups, and nutrition guidance help every rider cross that
          ...
          >
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              <span className="text-[#FFD84D] text-[11px] font-semibold tracking-[0.2em] uppercase">Fundraising</span>
            </div>
            <h3 className="font-heading text-white text-[26px] font-semibold">Every dollar counts.</h3>
            <p className="text-white/40 text-[14px] leading-relaxed">
