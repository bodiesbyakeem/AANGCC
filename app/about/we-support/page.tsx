        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="flex flex-col gap-6">
            ...
            <div className="space-y-4 text-white/75 text-[15px] leading-relaxed">
              ...
              <p>AANGCC has supported the National MS Society through the BP MS 150 since our founding — raising over $100,743 and counting. Every dollar raised goes directly toward MS research, programs, and advocacy.</p>
            </div>
            <div className="grid grid-cols-3 gap-4">
              {[
                { value: "1M", label: "Americans with MS" },
                { value: "$100743+", label: "Raised by AANGCC" },
