...
const MEMBER_EVENTS: RideEvent[] = [
  // ── Pre-June 2026 events (preserved exactly) ──
  { id: "1", title: "Group Ride — Govalle Neighborhood Park", date: "2026-04-04", time: "8:00 a.m.", category: "Ride" as Category, miles: "26 Miles", elevation: "866 Feet Elev.", description: "Route: Govalle Neighborhood Park", meetAt: "Govalle Neighborhood Park, 5200 Bolm Road, Austin, Texas 78721", postRide: "Monkey Nest Coffee, 5353 Burnet Road, Austin, Texas 78757" },
  { id: "2", title: "Group Ride — Govalle Neighborhood Park", date: "2026-04-11", time: "8:00 a.m.", category: "Ride" as Category, miles: "26 Miles", elevation: "866 Feet Elev.", description: "Route: Govalle Neighborhood Park", meetAt: "Govalle Neighborhood Park, 5200 Bolm Road, Austin, Texas 78721", postRide: "Monkey Nest Coffee, 5353 Burnet Road, Austin, Texas 78757" },
  { id: "3", title: "Group Ride — Buescher State Park", date: "2026-04-18", time: "9:00 a.m.", category: "Ride" as Category, miles: "22 Miles", elevation: "1,584 Feet Elev.", description: "Route: Buescher State Park", meetAt: "100 Park Road C, Smithville, Texas 78957", postRide: "Comfort Cafe, 111 NW 1st Street, Smithville, TX 78957" },
  { id: "4", title: "Mandatory Team Meeting", date: "2026-04-24", time: "5:30 - 6:30 p.m.", category: "Meeting" as Category, description: "Mandatory team meeting for all AANGCC members.", meetAt: "8140 Ceberry Drive #B, Austin, Texas 78759" },
  { id: "5", title: "2026 Texas Bike MS-150 — Day 1 | AUS-LG", date: "2026-04-25", time: "6:15 a.m.", category: "Event" as Category, description: "2026 Texas Bike MS-150 Day 1 from Austin to La Grange.", meetAt: "San Jacinto Parking Garage, 2401 San Jacinto Blvd., Austin, Texas 78701" },
  { id: "6", title: "2026 Texas Bike MS-150 — Day 2 | LG-CST", date: "2026-04-26", time: "6:15 a.m.", category: "Event" as Category, description: "2026 Texas Bike MS-150 Day 2 from La Grange to the coast.", meetAt: "Fayette County Fairgrounds, 1899 N. Jefferson Street, La Grange, Texas 78945" },
  { id: "celebration-2026", title: "Team Celebration Party 🎉", date: "2026-05-16", time: "4:00 p.m.", category: "Social" as Category, description: "Join us for our annual team celebration party! Food, drinks, and great company with your AANGCC family. Members and their guests only.", meetAt: "Rose Kirk Home, 4901 Interlachen Lane, Austin, Texas 78747", membersOnly: true },
  { id: "sat-may1", title: "Group Ride — Govalle Neighborhood Park", date: "2026-05-09", time: "8:00 a.m.", category: "Ride" as Category, miles: "26 Miles", elevation: "866 Feet Elev.", description: "Route: Govalle Neighborhood Park", meetAt: "Govalle Neighborhood Park, 5200 Bolm Road, Austin, Texas 78721", postRide: "Monkey Nest Coffee, 5353 Burnet Road, Austin, Texas 78757" },
  { id: "sat-may2", title: "Group Ride — Govalle Neighborhood Park", date: "2026-05-23", time: "8:00 a.m.", category: "Ride" as Category, miles: "26 Miles", elevation: "866 Feet Elev.", description: "Route: Govalle Neighborhood Park", meetAt: "Govalle Neighborhood Park, 5200 Bolm Road, Austin, Texas 78721", postRide: "Monkey Nest Coffee, 5353 Burnet Road, Austin, Texas 78757" },
  { id: "sat-may3", title: "Group Ride — Govalle Neighborhood Park", date: "2026-05-30", time: "8:00 a.m.", category: "Ride" as Category, miles: "26 Miles", elevation: "866 Feet Elev.", description: "Route: Govalle Neighborhood Park", meetAt: "Govalle Neighborhood Park, 5200 Bolm Road, Austin, Texas 78721", postRide: "Monkey Nest Coffee, 5353 Burnet Road, Austin, Texas 78757" },
  { id: "alz-2026", title: "Ride to End ALZ", date: "2026-10-17", time: "8:00 a.m.", category: "Event" as Category, miles: "40 Miles", elevation: "2,434 Feet Elev.", description: "Ride to End ALZ - Annual charity ride supporting the Alzheimer's Association.", meetAt: "Speeding Springs, 7100 Creek Road, Dripping Springs, Texas 78620", postRide: "Onsite - Sponsored by H.E.B., 7100 Creek Road, Dripping Springs, Texas 78620" },
  { id: "ms150-2027-day1", title: "2027 Texas Bike MS-150 — Day 1 | AUS-LG", date: "2027-04-24", time: "6:15 a.m.", category: "Event" as Category, description: "2027 Texas Bike MS-150 Day 1 from Austin to La Grange.", meetAt: "San Jacinto Parking Garage, 2400 San Jacinto Blvd., Austin, Texas 78701" },
  { id: "ms150-2027-day2", title: "2027 Texas Bike MS-150 — Day 2 | LG-CST", date: "2027-04-25", time: "6:15 a.m.", category: "Event" as Category, description: "2027 Texas Bike MS-150 Day 2 from La Grange to the coast.", meetAt: "Fayette County Fairgrounds, 1899 N. Jefferson Street, La Grange, Texas 78945" },
  { id: "alz-2027", title: "Ride to End ALZ", date: "2027-10-16", time: "8:00 a.m.", category: "Event" as Category, miles: "40 Miles", elevation: "2,434 Feet Elev.", description: "Ride to End ALZ - Annual charity ride supporting the Alzheimer's Association.", meetAt: "Speeding Springs, 7100 Creek Road, Dripping Springs, Texas 78620", postRide: "Onsite - Sponsored by H.E.B., 7100 Creek Road, Dripping Springs, Texas 78620" },

  // ── June 2026 through December 2027 (Bicycle House + Govalle pattern) ──
  {
    id: "bh20266",
        ...
        return (
          <button key={ev.id} onClick={() => onSelectEvent(ev)} className="w-full text-left p-4 rounded-xl bg-white/15 border border-white/20 hover:bg-white/25 transition-all duration-200">
            <div className="flex items-start gap-3">
              <div className={`w-2 h-2 rounded-full flex-shrink-0 mt-1.5 ${ev.membersOnly ? "bg-[#FFD84D]" : ev.category === "Meeting" ? "bg-[#FFD84D]" : ev.category === "Social" ? "bg-purple-400" : ev.category === "Event" ? "bg-orange-400" : "bg-white"}`} />
