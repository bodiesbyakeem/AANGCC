...
export default function DedicationVideoIntro({ forceShow = false, onClose }: DedicationVideoIntroProps) {
  ...
  const handleVideoEnd = () => {
    localStorage.setItem(STORAGE_KEY, "true");
    setTimeout(() => { setVisible(false); onClose?.(); }, 800);
  };
          ...
          <div className="relative z-10 w-full h-full flex flex-col items-center justify-between px-6 py-10 md:py-16">
            ...
            >
              <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <span className="text-[#FFD84D] text-[10px] md:text-[11px] font-semibold tracking-[0.3em] uppercase">Dedication Film</span>
                <span className="h-[1px] w-8 md:w-12 bg-[#FFD84D]/60" />
              </div>
              <h1 className="font-heading text-white leading-tight mb-4" style={{ fontSize: "clamp(32px, 6vw, 72px)" }}>
                2026 MS 150<br />Dedication Ride
              </h1>
